...
| 1-listit | script thet Display the contents list of your current directory |

| 2-bring_me_home | script that changes the working directory to the user’s home directory |

| 3-listfiles | script that Display current directory contents in a long format |

| 4-listmorefiles | script that Display current directory contents, including hidden files (starting with .). Use the long format |
...
| 8-firstdelete | script that Delete the file betty The file betty is in /tmp/my_first_directory |
...
| 12-file_type | script that cript that prints the type of the file named iamafile. The file iamafile will be in the /tmp directory when we will run your script |
